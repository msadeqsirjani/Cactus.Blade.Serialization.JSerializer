...
{
    public class JSerializerXmlSerializerTest
    {
        ...
        {
            Action action = () => new JSerializerXmlSerializer().SerializeToStream(null, new object(), typeof(object));
        ...
        {
            Action action = () => new JSerializerXmlSerializer().SerializeToStream(new MemoryStream(), null, typeof(object));
        ...
        {
            Action action = () => new JSerializerXmlSerializer().SerializeToStream(new MemoryStream(), new object(), null);
        ...
        {
            Action action = () => new JSerializerXmlSerializer().DeserializeFromStream(null, typeof(object));
        ...
        {
            Action action = () => new JSerializerXmlSerializer().DeserializeFromStream(new MemoryStream(), null);
        ...
        {
            Action action = () => new JSerializerXmlSerializer().SerializeToString(null, typeof(object));
        ...
        {
            Action action = () => new JSerializerXmlSerializer().SerializeToString(new object(), null);
        ...
        {
            Action action = () => new JSerializerXmlSerializer().DeserializeFromString(null, typeof(object));
        ...
        {
            Action action = () => new JSerializerXmlSerializer().DeserializeFromString("", null);
